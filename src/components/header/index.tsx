...
export function Header() {
  ...
  return (
    <header className="w-full  p-2.5 fixed top-0 z-50 ">
      <div className="flex items-center backdrop-blur-xl  bg-linear-to-l to-zinc-800/50 from-emerald-300/20 py-2.5 px-3 rounded-tl-2xl rounded-br-2xl border-2 border-zinc-700/60  max-w-5xl mx-auto drop-shadow-md drop-shadow-zinc-800/40">
        <nav className="flex w-full px-4 items-center gap-4">
          ...
          <div className="hidden sm:flex items-center gap-1 font-bold ">
            <Link className="hover:text-emerald-600 duration-300" href={"/"}>
              Games
            </Link>
            <Link
        ...
        <BiSolidJoystick className="text-3xl hidden sm:flex" />
        <button
      ...
      <div
        className={`flex sm:hidden font-bold flex-col items-center justify-center backdrop-blur-2xl   bg-linear-to-l to-zinc-800/50 
           from-emerald-300/20 py-2.5 px-3 rounded-tl-2xl rounded-br-2xl border-2 border-zinc-700/60  max-w-5xl mx-auto drop-shadow-md drop-shadow-zinc-800/40 mt-0.5 gap-3  z-50 duration-300 transition-all  ${open ? " max-h-40 opacity-100 " : "h-0 opacity-0"} `}
      >
        <Link
